              ...
              {services.map((item, index) => (
                ...
                >
                  <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                    ...
                    <div className="border-t border-gray-700 pt-4 items-center flex justify-between">
                      ...
                      <a
                        target="_blank"
                        href={`https://wa.me/5555COLOCARNUMERO?text=olá vim pelo site e gostaria de mais informações, sobre ${item.title}`}
